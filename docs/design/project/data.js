...
window.TRACKER_DATA = (function () {
  ...
  const posts = [
    {
      id: 'p1', who: 'ba', time: '2026/6/7', ts: 3,
      body: '誰可以救救我\n這次至少20%回檔～ 我已經 All in 腳麻了啊啊\n看不懂的可以 google 用圖片搜尋',
      source: '看原文', signals: [],
    },
    {
      id: 'p2', who: 'ba', time: '2026/6/7', ts: 4,
      body: '糟糕，龜吉有 36 dayjust',
      source: '看原文', signals: [],
    },
    {
      id: 'p3', who: 'ba', time: '2026/6/7', ts: 13,
    ...
    {
      id: 'p4', who: 'dad', time: '2026/6/6', ts: 18,
      body: '星期一是不是會有大場面？就叫大家不要 ALL IN 了。🥺',
      source: '看原文', signals: [],
    },
    {
      id: 'p5', who: 'dad', time: '2026/6/6', ts: 19,
      body: '我爸已經73歲系列29\n昨天叫他停損，他說「股票放著總會回來」\n然後就去睡午覺了',
      source: '看原文', signals: [],
    },
    {
      id: 'p6', who: 'guc', time: '2026/6/6', ts: 30,
    ...
    {
      id: 'p7', who: 'guc', time: '2026/6/4', ts: 72, kind: 'podcast',
    ...
    {
      id: 'p8', who: 'aoi', time: '2026/6/4', ts: 73,
    ...
    {
      id: 'p9', who: 'aoi', time: '2026/6/4', ts: 74,
      body: '看了一下那時候的股價 再看看現在的\n那時候也一起上車吃到肉的朋友也太幸福',
      source: '看原文', signals: [],
    },
    {
      id: 'p10', who: 'dad', time: '2026/6/4', ts: 75,
    ...
    {
      id: 'p11', who: 'guc', time: '2026/6/3', ts: 96,
    ...
    {
      id: 'p12', who: 'dad', time: '2026/6/2', ts: 120,
      body: '我爸已經73歲系列27\n他今天宣布「這次真的要長期投資」\n我們上次聽到這句話是上禮拜三',
      source: '看原文',
      signals: [
