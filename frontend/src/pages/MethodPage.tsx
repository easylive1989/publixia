...
export default function MethodPage() {
  return (
    <main className="wrap doc">
      ...
      <ul>
        <li><strong>動能</strong>：5、20、60 日報酬率的歷史百分位平均。</li>
        <li><strong>距高點回撤</strong>：收盤相對近 252 日最高點跌幅的歷史百分位。</li>
        <li><strong>反向波動率</strong>：20 日實現波動率的歷史百分位取反。</li>
        <li>
          <strong>市場寬度</strong>：證交所上市股票
          <span className="mono"> (上漲家數 + 0.5 × 平盤家數) ÷ 總家數</span>。
        </li>
